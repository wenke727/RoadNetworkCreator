...
mv osm.net.xml osm.net_old.xml
/usr/share/sumo/bin/netconvert --node-files osm.nod.xml --edge-files osm.edg.xml -o osm.net.xml -t /usr/share/sumo/data/typemap/osmNetconvert.typ.xml --geometry.remove --roundabouts.guess -v --junctions.join --tls.guess-signals --tls.discard-simple --tls.join --output.original-names --junctions.corner-detail 5 --output.street-names --tls.default-type actuated  --keep-edges.by-vclass passenger
# polyconvert
