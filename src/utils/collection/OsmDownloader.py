...
# Ref: https://www.cnblogs.com/feffery/p/12483967.html
...
class OsmDownloader:
    ...
    def download_geojson(self, path=''):
        ...
        print('=' * 200)
        print('开始导出数据！')
        self.points.to_file(os.path.join(path, f'{self.area}_osm路网_节点.geojson'), driver='GeoJSON')
        self.ways.to_file(os.path.join(path, f'{self.area}_osm路网_道路.geojson'), driver='GeoJSON')
        print('=' * 200)
        print('数据导出成功！')
